...
int main(void) {
  ...
  //O_CREAT: flag; create sem if dne, else do ntg
  //0644: owner(R and W) others have only R permissions
  //0: initial value of sema
  ...
  while (1) {
    if (msgrcv(msgqid, &msg, sizeof(msg.pyld), 1, 0) == -1) {
      ...
      //copies a block of memory to a location irrespective of the data types
